 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://models", wsdlLocation = "http://localhost:8080/ws/countries.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRIESPORTSERVICE_QNAME = new QName("http://models", "CountriesPortService");
    ...
    public CountriesPort getCountriesPortSoap11() {
        return super.getPort(new QName("http://models", "CountriesPortSoap11"), CountriesPort.class);
    }
    ...
    public CountriesPort getCountriesPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://models", "CountriesPortSoap11"), CountriesPort.class, features);
    }
